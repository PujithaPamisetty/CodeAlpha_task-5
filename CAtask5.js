function inputs(userName, bookName, type) {
  ...
  function formSubmit(e) {
    ...
    let givenType;
    let checkTechnical = document.getElementById("Technical");
    let checkPrograming = document.getElementById("Non-Technical");
    if (checkTechnical.checked) {
      givenType = checkTechnical.value;
    } else if (checkNon-Technicalg.checked) {
      givenType = checkNon-Technical.value;
    }  
